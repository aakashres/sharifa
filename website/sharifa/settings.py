"""
Django settings for sharifa project.
...
SECRET_KEY = '6#5p*y&4fm#zip+e#ar@tg%9a#-8r9)75h+t=(6edvn*8snyz*'
...
WSGI_APPLICATION = 'sharifa.wsgi.application'
